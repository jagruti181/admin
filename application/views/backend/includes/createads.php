	...
	<div class="col-lg-12">
	    <section class="panel">
			...
			<div class="panel-body">
				<form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('site/createadssubmit');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						   <?php 
								 echo form_dropdown('area',$area,set_value('area'),'class="chzn-select form-control" data-placeholder="Choose a category..."');
							?>
						</div>
					</div>
					<div class="form-group">
						   ...
						   <?php 
							$featured = array(
								...
								"2" => "No"
								 ...
								 echo form_dropdown('featured',$featured,set_value('featured'),'class="chzn-select form-control" data-placeholder="Choose a category..."');
							?>
						</div>
					</div>
					<div class="form-group">
