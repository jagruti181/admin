	...
	<div class="col-lg-12">
	    <section class="panel">
			...
			<div class="panel-body">
				<form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('site/editnewsletterusersubmit');?>">
						...
						<div class="col-sm-4">
						  ...
						  <table class="table rowtable">
							...
							<tbody class="emailbody">
								<?php
								foreach($before['email'] as $key => $row)
								{  ?>
									<tr><td><input type='email' name='email[]' class='form-control' style='width:90%;float:left' value="<?php echo set_value('email',$row); ?>">&nbsp;<button class='deleteemail btn btn-xs btn-danger pull-right'><i class='icon-minus-sign '></i></button></td></tr>
						  <?php } ?>
							</tbody>
						  </table>
						</div>
